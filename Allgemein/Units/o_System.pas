...
type
  ...
  public
    ...
    ///	<summary>
    ///	  Überprüft, ob eine Datei vorhanden ist. Falls diese Datei nicht
    ///	  gefunden wird, wird versucht eine Verbindung zum Netzwerk aufzubauen
    ///	  und danach wird nochmals überprüft, ob die Datei vorhanden ist.
    ///	</summary>
    ///	<returns>
    ///	  Result = 0 / Datei existiert.<br />Result = -1 / Datei existiert nicht
    ///	  <br />Result = -2 / Netzwerkverbindung konnte nicht hergestellt
    ///	  werden.
    ///	</returns>
