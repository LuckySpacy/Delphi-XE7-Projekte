unit o_SeiteDokumentLink_BaseStruk;
...
begin
  ...
  inherited;
  FDBList.Add(SK_SE_ID, SK_SE_ID);
  FDBList.Add(SK_SE_ID_LINK, SK_SE_ID_LINK);
...
begin
  iSql := ' insert into ' + getTableName +
          ' (SK_ID, SK_SE_ID, SK_SE_ID_LINK, SK_DO_ID, SK_VERLINKT, SK_DELETE)' +
          ' values' +
          ' (:SK_ID, :SK_SE_ID, :SK_SE_ID_LINK, :SK_DO_ID, :SK_VERLINKT, :SK_DELETE)';
  uSql := ' update ' + getTablename +
          ' set SK_SE_ID = :SK_SE_ID,' +
