...
begin
  ...
  fQryMySqlI.SQL.Text := 'INSERT INTO aktie(AK_ID, AK_WKN, AK_AKTIE, AK_BI_ID, AK_DEPOT) VALUES (:akid,:wkn,:aktie,:biid,:depot)';
  fQryMySqlU.SQL.Text := 'UPDATE aktie SET AK_WKN = :wkn, AK_AKTIE=:aktie,AK_BI_ID=:biid,AK_DEPOT=:depot WHERE ak_id = :akid';
end;
